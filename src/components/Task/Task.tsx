...
export function Task({id, title, isCompleted, onTaskDone, onTaskDeleted }:TaskProps) {
  return (
    <View style={styles.taskContainer}>
      ...
      <MaterialCommunityIcons name={isCompleted ? "check-decagram-outline" : "checkbox-blank-circle-outline"}
       size={22} 
      ...
      <MaterialCommunityIcons name="trash-can-outline" size={20} color={theme.colors.base.gray300} />
      </TouchableOpacity>
    </View>
  )
}